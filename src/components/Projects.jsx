...
import drippyimgImg from '../assets/drippyimg.png'
...
function Projects({ darkMode }) {
  const projects = [
    ...
    },
    {
      id: 3,
      title: "Dripy Store",
      description: "My personal E-Commerce website built with React, Tailwind CSS and Framer Motion animations.",
      tech: ["React", "Tailwind", "Framer Motion"],
      status: "Live",
      liveLink: "https://dripystore.netlify.app",
      githubLink: null,
      image: drippyimgImg
    },
  ]
